                        ...
                        <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                            <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                                ...
                                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                                    <select title="Select project" className="select-field min-w-[210px]" value={selectedProjectId || ''} onChange={(event) => setSelectedProjectId(Number(event.target.value))}>
                                        {projects.map((project) => (
                                            <option key={project.id} value={project.id}>{project.name}</option>
                                        ))}
                                    </select>
                                    <input className="search-input mb-0 min-w-[210px]" placeholder="Search tasks" value={search} onChange={(event) => setSearch(event.target.value)} />
                                    <select title="Filter tasks by status" className="select-field min-w-[170px]" value={statusFilter} onChange={(event) => setStatusFilter(event.target.value)}>
                                    ...
                                    <select title="Filter tasks by assignee" className="select-field min-w-[170px]" value={assigneeFilter} onChange={(event) => setAssigneeFilter(event.target.value)}>
